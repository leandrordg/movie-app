...
export const getDiscoverTvs = async (): Promise<TvRequest> => {
...
export const getPopularTvs = async (): Promise<TvRequest> => {
  const response = await fetch(
...
export const getTopRatedTvs = async (): Promise<TvRequest> => {
  const response = await fetch(
