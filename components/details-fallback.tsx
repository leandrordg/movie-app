  ...
  return (
    <div>
      ...
      <div className="flex items-start gap-8 max-w-7xl mx-auto py-12 px-4 space-y-4 relative">
        <div className="aspect-3/4 max-w-64 w-64 rounded-md overflow-clip hidden md:block bg-muted animate-pulse" />
        <div className="space-y-4 flex-1">
          <div className="hidden md:block absolute -top-12 left-4 w-64 h-10 rounded-md bg-background animate-pulse" />
